        ...
        <div class="mt-10">
            <form action="" autocomplete="">
                ...
                <div class="text-center mt-6">
                    <input type="button" @click="login(email,password)" name="signin" id="signin" value="Sign In" class="p-3 rounded-full bg-blue-900 outline-none text-white shadow w-32 justify-center focus:bg-purple-700 hover:bg-purple-500" required>
                </div>
...
if(email==''|| password==""){
errorLog="Email/Password is empty"
}else{
