<template>
  <div id="login_page" class="flex flex-col items-center justify-center bg-gray-100 h-screen select-none">
    <div class="flex flex-col -mt-32 bg-white px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-xl shadow-2xl w-full max-w-md  border-l-4 border-blue-900">
        <div class="font-bold self-center text-xl sm:text-2xl uppercase w-30 text-center text-blue-600 rounded-full p-6 ">Sign In</div>
        <div class="mt-10">
            <form action="" autocomplete="">
                ...
                <div class="text-center mt-6">
                    <input type="button" @click="signIn(email,password)" name="signin" id="signin" value="Sign In" class="p-3 rounded-full bg-yellow-500 outline-none text-white shadow w-32 justify-center focus:bg-purple-700 hover:bg-purple-500" required>
                </div>
                <div class="flex flex-wrap mt-6">
                    <div class="w-1/2 text-left">
                        <a href="#" class="text-blue-600 text-xl"><small>Forgot password?</small></a>
                    </div>
                    <div class="w-1/2 text-right">
                        <a href="#" @click="signup" class="text-blue-600 text-xl rounded-lg"><small>Sign up</small></a>
                    </div>
                </div>
            </form>
